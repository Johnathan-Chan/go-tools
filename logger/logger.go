...
import (
	...
	"github.com/Johnathan-Chan/go-tools/logger/lumberjack"
	"go.uber.org/zap"
...
func WithDisableConsole(console bool) Option {
	return func(opt *option) {
		opt.disableConsole = console
	}
}
...
func WrapMeta(err error, namespace string, metas ...Meta) (fields []zap.Field) {
	...
	if namespace != ""{
		fields = append(fields, zap.Namespace(namespace))
	}else{
